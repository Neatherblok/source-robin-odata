...
import pytest
from source_robin_odata.source import RobinOdataStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(RobinOdataStream, "path", "v0/example_endpoint")
    mocker.patch.object(RobinOdataStream, "primary_key", "test_primary_key")
    mocker.patch.object(RobinOdataStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = RobinOdataStream()
